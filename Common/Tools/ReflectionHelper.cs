...
namespace CommonLib.Tools
{
    public static class ReflectionHelper
    {
        ...
        /// <returns></returns>
        public static string GetDescription<T>() => GetDescription(CommonHelper.GetType<T>());
        ...
        /// <returns></returns>
        public static string GetDescription<T>(string memberName) => GetDescription(CommonHelper.GetType<T>(), memberName);
        ...
        /// <typeparam name="T">类型</typeparam>
        /// <returns></returns>
        public static string GetDisplayName<T>() => GetDisplayName(CommonHelper.GetType<T>());
