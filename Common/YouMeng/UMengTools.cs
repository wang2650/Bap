...
namespace CommonLib.YouMeng
{
    public static class UMengTools
    {
        ...
        private readonly static string AppAndroidSecret = CommonLib.Tools.ConfigHelper.GetJsonConfig().GetSection("YuMeng").GetSection("YMAndroidSecret").Value.ToString().Trim();
        private readonly static string AppIosMasterSecret = CommonLib.Tools.ConfigHelper.GetJsonConfig().GetSection("YuMeng").GetSection("YMIosMasterSecret").Value.ToString().Trim();
