...
namespace CommonLib.Helpers
{
    ...
    public static class Reflection
    {
        ...
        private static bool MatchGeneric(Type findType, Type type)
        {
            ...
            foreach (Type implementedInterface in type.FindInterfaces((filiter, criteria) => true, null))
            {
        ...
        /// <returns></returns>
        public static string GetMethodInfo(bool isIncludeParentClassInfo = false)
        {
            string str = "";

            ////取得当前方法命名空间
            //str += "命名空间名:" + System.Reflection.MethodBase.GetCurrentMethod().DeclaringType.Namespace + Common.Line;

            //取得当前方法类全名 包括命名空间
            str += "类名:" + System.Reflection.MethodBase.GetCurrentMethod().DeclaringType.FullName + Common.Line;

            //取得当前方法名
            str += "方法名:" + System.Reflection.MethodBase.GetCurrentMethod().Name+ Common.Line; ; 
            if (isIncludeParentClassInfo)
            {
                //父方法
                ...
                //取得父方法命名空间
                str += mb.DeclaringType.Namespace + Common.Line;

                //取得父方法类名
                str += mb.DeclaringType.Name + Common.Line;

                //取得父方法类全名
                str += mb.DeclaringType.FullName + Common.Line;

                //取得父方法名
                str += mb.Name + Common.Line; 
            }
            return str;
        }
    }
