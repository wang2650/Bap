...
namespace WXQ.InOutPutEntites.Input.SystemManage.Menu
{
    ...
    public class UpdateMenuInputModelValidation : AbstractValidator<UpdateMenuInput>
    {
        public UpdateMenuInputModelValidation()
        {
            CascadeMode = CascadeMode.StopOnFirstFailure;
            RuleFor(x => x.MenuId).NotEmpty().WithMessage("菜单id不能为空").GreaterThanOrEqualTo(0).WithMessage("菜单id大于0");
